...
namespace WebApplication2.Controllers
{
    ...
    public class procedureApiController : ControllerBase
    {
        ...
        //             contactName = contactNameParam.Value.ToString();
        //         }
        //         using (NpgsqlTransaction transaction = npgsqlConnection.BeginTransaction())
        //         {
        //             using (NpgsqlCommand cmd = new NpgsqlCommand(@"call GetAllNumbers(:p_ContactId,:Ref_cursor)", npgsqlConnection, transaction))
        //             {
        //                 cmd.Parameters.AddWithValue("p_ContactId", NpgsqlDbType.Integer, id);
        //                 var cursorreference = new NpgsqlParameter("Ref_cursor", NpgsqlDbType.Refcursor)
        //                 {
        //                     Direction = ParameterDirection.InputOutput,
        //                     Value = "getCursor"
        //                 };
        //                 cmd.Parameters.Add(cursorreference);
        //                 cmd.ExecuteNonQuery();
        ...
        //                         {
        //                             NumberId = reader.GetInt32(1), // NumberId is at index 1
        //                             PhoneNumber = reader.GetString(0) // PhoneNumber is at index 0
        //                         });
        //                     }
        //                 }

        //                 // cmd.CommandText = "Fetch all in getCursor";
        ...
        //                 //     NumberDetails.Add(new Alternewcontactresponse
        //                 //     {
        //                 //         NumberId = dr.GetInt32(0),
        //                 //         PhoneNumber = dr.GetString(1)
        //                 //     }
        //                 //      );
        //                 // }
        //                 // dr.Close();
